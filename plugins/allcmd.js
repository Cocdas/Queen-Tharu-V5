...
async (conn, mek, m, { from, quoted, body, isCmd, command, args, q, isGroup, sender, senderNumber, botNumber2, botNumber, pushname, isMe, isOwner, groupMetadata, groupName, participants, groupAdmins, isBotAdmins, isAdmins, reply }) => {
    try {
        ...
        let userInfo = `     🔍_*QUEEN_THARU_V❼ STALK*_🔎
...
let about = ` HELLOW THEIR ${senderNumber} I AM 💃QUEEN_THARU_V❼ WHATSAPP BOT 
              CREATED BY QUEEN_THARU_V❼..
              
              
              THANKS FOR USING QUEEN_THARU_V❼ WHATSAPP BOT MD`
...
try{
  ...
  await m.react('✅');
  let video = data.url;
  let dev = 'QUEEN_THARU_V❼ Instagram Downloader | Download with ease, cherish forever.'
...
💬 "${quote.content}"
- ${quote.author}
*🔮 𝐏𝐨𝐰𝐞𝐫𝐞𝐝 𝐁𝐲 - : QUEEN_THARU_V❼* QUOTES
        `;
...
*💻 GitHub:* github.com/dark-chami21 `;
